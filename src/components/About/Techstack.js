...
import R from "../../Assets/TechIcons/R.png";
import PBI from "../../Assets/TechIcons/PowerBi.png";
import Excel from "../../Assets/TechIcons/excel.png";
import powerapp from "../../Assets/TechIcons/powerapp.png";
  ...
  return (
    <Row style={{ justifyContent: "center", paddingBottom: "50px" }}>
      <Col xs={4} md={2} className="tech-icons">
        <img src={Excel} alt="R" className="tech-icon-images" />
        <div className="tech-icons-text">Excel</div>
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <img src={PBI} alt="R" className="tech-icon-images" />
      ...
      <Col xs={4} md={2} className="tech-icons">
        <img src={powerapp} alt="R" className="tech-icon-images" />
        <div className="tech-icons-text">Powerapp</div>
      </Col>
      {/* <Col xs={4} md={2} className="tech-icons">
        <img src={Go} alt="go" />
      ...
      <Col xs={4} md={2} className="tech-icons">
        <img src={R} alt="R" className="tech-icon-images" />
        <div className="tech-icons-text">R Studio</div>
      </Col>
